      ...
      <div className="w-full max-w-[400px] space-y-8">
        <div className="flex flex-col items-center text-center space-y-4">
          ...
          <div className="space-y-1">
            <h1 className="text-2xl font-black text-white tracking-tighter uppercase italic">Welcome Back</h1>
            <p className="text-[10px] font-bold text-zinc-600 uppercase tracking-[0.2em]">Log in to your account</p>
          </div>
        </div>
